...
var AutheticateUserService_1 = __importDefault(require("../services/AutheticateUserService"));
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                autheticateUser = new AutheticateUserService_1.default();
                return [4 /*yield*/, autheticateUser.execute({
                        email: email,
                        password: password,
                    })];
            case 1:
